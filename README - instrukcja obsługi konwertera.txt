...
(1) Do poprawnego działania potrzebne są :
	...
	(1.4)
		...
		skopiować zawartość konsoli przeglądarki do pliku 'startowy-plik-z-css.html' (po skopiowaniu tekstu z konsoli przeglądarki należy usunąć wszystkie wpisy zaczynające się od 'app.component.ts')
